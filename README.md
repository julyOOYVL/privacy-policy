...
- Track **daytime and nighttime flight hours**.  
...
### 3. UTC Time
- Quickly check the current UTC time.

### 4. Hours Between Dates
- Input a start and end date to calculate the total hours between them.  

---

## Repository Purpose

This repository contains the **static website** for P-Pilot's **Privacy Policy**. The website is hosted on **GitHub Pages** and provides a public link to comply with Google Play Store and App Store requirements.
